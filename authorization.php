...
try{
    ...
    <div class="wrapper" id="wrapper_auth">
        <div class="header">
        ...
        <form method="post">
            <div>
                ...
                <input class="user-input" type="text" name="login" id="name" placeholder="Логин"
            ...
            <div class="password">
                ...
                <input type="password" name="password" id="password-input" placeholder="Пароль" required>
